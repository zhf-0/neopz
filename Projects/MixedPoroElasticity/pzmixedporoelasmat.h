/**
 * @file
 * @brief Contains the TPZMixedPoroElasticityMaterial class which implements a two dimensional elastic material in plane stress or strain.
 */

#ifndef MIXEDPOROELASMATHPP
#define MIXEDPOROELASMATHPP
 ...
 */
class TPZMixedPoroElasticityMaterial : public TPZDiscontinuousGalerkin {
    ...
    TPZMixedPoroElasticityMaterial();
    /**
     ...
     */
    TPZMixedPoroElasticityMaterial(int id, REAL E, REAL nu, REAL fx, REAL fy, int planestress = 1, int fDimension=1);
    
    /// dimension of the material
    
    TPZMixedPoroElasticityMaterial(int id);
    
    /** @brief Copies the data of one TPZMixedPoroElasticityMaterial object to another */
    TPZMixedPoroElasticityMaterial(const TPZMixedPoroElasticityMaterial &copy);
    ...
    virtual TPZMaterial * NewMaterial() { return new TPZMixedPoroElasticityMaterial(*this);}
    
    /** @brief Default destructor */
    virtual ~TPZMixedPoroElasticityMaterial();
    ...
    std::string Name() { return "TPZMixedPoroElasticityMaterial"; }
    ...
    /** @brief Applies the element boundary conditions MixedPoro */
