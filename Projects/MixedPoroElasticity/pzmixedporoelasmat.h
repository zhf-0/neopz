 ...
 */
class TPZPoroElasticityMaterial : public TPZDiscontinuousGalerkin {
	 ...
	 */
	TPZPoroElasticityMaterial(int id, REAL E, REAL nu, REAL fx, REAL fy, int planestress = 1, int fDimension=1);
    
    /// dimension of the material
    
    TPZPoroElasticityMaterial(int id);
	
	/** @brief Copies the data of one TPZElasticityMaterial object to another */
	TPZPoroElasticityMaterial(const TPZPoroElasticityMaterial &copy);
	...
	virtual TPZMaterial * NewMaterial() { return new TPZPoroElasticityMaterial(*this);}
	
	/** @brief Default destructor */
	virtual ~TPZPoroElasticityMaterial();
     ...
     */
    void SetPoroElasticParameters(REAL Eyoung, REAL nu)
    {
