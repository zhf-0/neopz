...
//                    TPZCreateApproximationSpace::CreateInterfaces(*cmesh);
	...
	file += filename;
	// If discontinuous create interface elements
	if(discontinuous)
         TPZCreateApproximationSpace::CreateInterfaces(*cmesh);
	// Printing geo mesh to verify
	PrintGeoMeshInVTKWithDimensionAsData(cmesh->Reference(),"initialGMesh.vtk");
