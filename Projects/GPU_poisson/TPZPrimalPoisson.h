...
/**
 * @brief Material that implements Continuous Galerkin Approximation of laplace equation
 *        This material consider exactly just laplace equation.
 */
...
public:
    ...
    TPZPrimalPoisson(int mat_id, int dimension);
