...
class TPZPoroElasticUnsat : public TPZDiscontinuousGalerkin {
...
public:
	...
	TPZPoroElasticUnsat(int matid, int dim);
	
	virtual ~TPZPoroElasticUnsat();
	
	virtual void Print(std::ostream & out);
	
	virtual std::string Name() { return "TPZPoroElasticUnsat"; }
