...
//    }
    ...
    for(int i = 0; i < nshapeV; i++ )
    {
        ...
        for(int j = 0; j < nshapeV; j++){
            ...
            STATE fact =(-1.) * weight * fViscosity * InnerVec(phiVtit, GradVnj) ;
            ek(i,j) += fact ;
            ek(j,i) += fTheta*fact;
...
//        TPZVec<double> p_D;
//        
//        if(this->HasfForcingFunctionExactPressure()){
//            this->ForcingFunctionExactPressure()->Execute(datavec[vindex].x, p_D);
//        }
//        
//        REAL p_D1 = p_D[0];
//        
...
//            //                }
//            
//            ef(i+nshapeV) += 1.0 * p_D1 * phiP(i,0);
//            
//            for(int j = 0; j < nshapeP; j++){
//                
//                //                    for (int e=0; e<fDimension; e++) {
...
//                //                    }
//                
//                ek(i+nshapeV,j+nshapeV) += 1.0 * (phiP(i,0) * phiP(j,0));
//                
//            }
//            
//        }
        ...
        for(int j = 0; j < nshapeV; j++){
            ...
            STATE fact1=(-1.) * weight * fViscosity * InnerVec(phiVi, GradVnj) ;
            
//            TPZFNMatrix<9> vh(v_h.size(),1,0.);
//            for (int e=0; e<fDimension; e++) {
//                    vh(e,0)=v_h[e];
//            }
//            
//            STATE fact2=(-1.) * weight * fViscosity * InnerVec(vh, GradVnj) ;
////
...
//            
//            
////            STATE factfp= (1.) * weight * fViscosity * phiVni(0,0)*p_D;
////            
////            ef(j+nshapeV,0) += factfp ;
//            
//            
