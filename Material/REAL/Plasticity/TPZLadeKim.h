 ...
 * comprised of a LadeKim Plastic flow rule and yield criterion
...
public:
    ...
    void SetUp(REAL poisson, REAL M, REAL lambda,
        ...
        LADEKIMPARENT::fYieldCriterion.SetUp(ksi1, ksi2, h, alpha, mu, neta1, m, fabs(pa));
        LADEKIMPARENT::fElasticResponse.SetUp(lambda, M, poisson, fabs(pa));
        LADEKIMPARENT::fThermodynamicalForce.SetUp(ksi1, p, h, C, fabs(pa));
    ...
    virtual void Write(TPZStream &buf) const {
        ...
        buf. Write(&fYieldCriterion.fKsi1, 1);
        buf. Write(&fYieldCriterion.fh, 1);
        buf. Write(&fYieldCriterion.fAlpha, 1);
        buf. Write(&fYieldCriterion.fKsi2, 1);
        buf. Write(&fYieldCriterion.fMu, 1);
    ...
    virtual void Read(TPZStream &buf) {
        ...
        buf. Read(&fYieldCriterion.fKsi1, 1);
        buf. Read(&fYieldCriterion.fh, 1);
        buf. Read(&fYieldCriterion.fAlpha, 1);
        buf. Read(&fYieldCriterion.fKsi2, 1);
        buf. Read(&fYieldCriterion.fMu, 1);
...
public:
    ...
    // Lade, Paul V. Kim, Moon K. Single Hardening Constitutive Model for Soil, Rock and Concrete. 
    ...
    switch (icase) {
        case 0:
        {
            ...
            PlasticResidual<REAL, TFAD>
                    (fPlasticState, Np1_FAD, delGamma_FAD, epsRes_FAD, normEpsPErr);
...
inline void TPZLadeKim::Residual(TPZFMatrix<REAL> &res, int icase) {
    ...
    switch (icase) {
        case 0:
        {
            ...
            //Compute Residual
            PlasticResidual<REAL>(fPlasticState, Np1, delGamma, epsRes, normEpsPErr);
