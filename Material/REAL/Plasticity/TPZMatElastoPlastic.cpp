...
void TPZMatElastoPlastic<T, TMEM>::Solution(TPZMaterialData &data, int var, TPZVec<REAL> &Solout) {
    ...
    if (var == TPZMatElastoPlastic<T, TMEM>::EDisplacement) {
        ...
        Sigma.EigenValuesJacobi(Solout);
...
template class TPZMatElastoPlastic<TPZPlasticStepPV<TPZYCMohrCoulombPV>>;

template class TPZMatElastoPlastic<TPZPlasticStep<TPZYCModifiedMohrCoulomb>>;
//template class TPZMatElastoPlastic<TPZModifiedMohrCoulomb>;

template class TPZMatElastoPlastic<TPZPlasticStep<TPZYCWillamWarnke>>;
template class TPZMatElastoPlastic<TPZWillamWarnke>;


template class TPZMatElastoPlastic<TPZLadeKim>;
template class TPZMatElastoPlastic<TPZSandlerDimaggio<SANDLERDIMAGGIOSTEP1>>;
template class TPZMatElastoPlastic<TPZSandlerDimaggio<SANDLERDIMAGGIOSTEP2>>;


template class TPZMatElastoPlastic<TPZPlasticStep<TPZYCDruckerPrager>>;
template class TPZMatElastoPlastic<TPZDruckerPrager>;

template class TPZMatElastoPlastic<TPZPlasticStep<TPZYCMohrCoulomb>>;
template class TPZMatElastoPlastic<TPZMohrCoulomb>;

template class TPZMatElastoPlastic<TPZPlasticStep<TPZYCVonMises>>;
...
template class TPZMatElastoPlastic<TPZPlasticStep<TPZYCDruckerPrager>, TPZPoroElastoPlasticMem>;

template class TPZMatElastoPlastic<TPZElasticCriterion, TPZElastoPlasticMem>;

template class TPZMatElastoPlastic<TPZPlasticStepPV<TPZSandlerExtendedPV>>;

template class TPZRestoreClass< TPZMatElastoPlastic<TPZPlasticStepPV<TPZYCMohrCoulombPV>>, TPZMOHRCOULOMBPV_ID >;
