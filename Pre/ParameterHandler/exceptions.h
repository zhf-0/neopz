...
#include "numbers.h" //deal_ii_include
#include "types.h" //deal_ii_include
                      ...
                      ExceptionType     e)
    {
      ...
      switch (handling)
        ...
        case abort_on_exception:
          deal_II_exceptions::internals::abort(e);
          break;
 ...
 */
#define AssertIsFinite(number) Assert(numbers::is_finite(number), \
