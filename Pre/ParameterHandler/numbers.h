...
namespace std
{
  template <typename Number> ::VectorizedArray<Number>
  sqrt(const ::VectorizedArray<Number> &);
  template <typename Number> ::VectorizedArray<Number>
  abs(const ::VectorizedArray<Number> &);
  template <typename Number> ::VectorizedArray<Number>
  max(const ::VectorizedArray<Number> &, const ::VectorizedArray<Number> &);
  template <typename Number> ::VectorizedArray<Number>
  min (const ::VectorizedArray<Number> &, const ::VectorizedArray<Number> &);
  template <typename Number> ::VectorizedArray<Number>
