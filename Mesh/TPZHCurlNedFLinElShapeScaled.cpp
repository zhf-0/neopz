...
void TPZHCurlNedFLinEl::Shape(TPZVec<REAL> &qsi, TPZFMatrix<REAL> &phi,
    ...
    case 13:
        phi(currentFuncPos, 0) =
            1 - 156 * qsi[0] + 6006 * pow(qsi[0], 2) - 100100 * pow(qsi[0], 3) +
            900900 * pow(qsi[0], 4) - 4900896 * pow(qsi[0], 5) +
            17153136 * pow(qsi[0], 6) - 39907296 * pow(qsi[0], 7) +
            62355150 * pow(qsi[0], 8) - 64664600 * pow(qsi[0], 9) +
            42678636 * pow(qsi[0], 10) - 16224936 * pow(qsi[0], 11) +
    ...
    case 11:
        phi(currentFuncPos, 0) =
            1 - 110 * qsi[0] + 2970 * pow(qsi[0], 2) - 34320 * pow(qsi[0], 3) +
            210210 * pow(qsi[0], 4) - 756756 * pow(qsi[0], 5) +
            1681680 * pow(qsi[0], 6) - 2333760 * pow(qsi[0], 7) +
            1969110 * pow(qsi[0], 8) - 923780 * pow(qsi[0], 9) +
            184756 * pow(qsi[0], 10);
        currentFuncPos--;
    case 10:
        phi(currentFuncPos, 0) =
    ...
    case 9:
        phi(currentFuncPos, 0) =
            1 - 72 * qsi[0] + 1260 * pow(qsi[0], 2) - 9240 * pow(qsi[0], 3) +
            34650 * pow(qsi[0], 4) - 72072 * pow(qsi[0], 5) +
            84084 * pow(qsi[0], 6) - 51480 * pow(qsi[0], 7) +
            12870 * pow(qsi[0], 8);
        currentFuncPos--;
    case 8:
        phi(currentFuncPos, 0) =
        ...
        currentFuncPos--;
    case 7:
        phi(currentFuncPos, 0) = 1 - 42 * qsi[0] + 420 * pow(qsi[0], 2) -
                                 1680 * pow(qsi[0], 3) + 3150 * pow(qsi[0], 4) -
                                 2772 * pow(qsi[0], 5) + 924 * pow(qsi[0], 6);
        currentFuncPos--;
    case 6:
        phi(currentFuncPos, 0) = -1 + 30 * qsi[0] - 210 * pow(qsi[0], 2) +
