...
void TPZHCurlNedFLinEl::Shape(TPZVec<REAL> &qsi, TPZFMatrix<REAL> &phi,
  ...
  switch (pOrder) {
    ...
    case 9:
      phi(currentFuncPos, 0) =
          orient * (218790 * (1 - 72 * qsi[0] + 1260 * pow(qsi[0], 2) -
    ...
    case 8:
      phi(currentFuncPos, 0) =
          orient * (51480 * (-1 + 56 * qsi[0] - 756 * pow(qsi[0], 2) +
    ...
    case 7:
      phi(currentFuncPos, 0) =
          orient * (12012 * (1 - 42 * qsi[0] + 420 * pow(qsi[0], 2) -
                             1680 * pow(qsi[0], 3) + 3150 * pow(qsi[0], 4) -
                             2772 * pow(qsi[0], 5) + 924 * pow(qsi[0], 6)));
      currentFuncPos--;
    case 6:
      phi(currentFuncPos, 0) =
          orient * (2772 * (-1 + 30 * qsi[0] - 210 * pow(qsi[0], 2) +
                            560 * pow(qsi[0], 3) - 630 * pow(qsi[0], 4) +
                            252 * pow(qsi[0], 5)));
      currentFuncPos--;
    case 5:
      phi(currentFuncPos, 0) =
          orient * (630 * (1 - 20 * qsi[0] + 90 * pow(qsi[0], 2) -
                           140 * pow(qsi[0], 3) + 70 * pow(qsi[0], 4)));
      currentFuncPos--;
    case 4:
      phi(currentFuncPos, 0) =
          orient * (140 * (-1 + 12 * qsi[0] - 30 * pow(qsi[0], 2) +
                           20 * pow(qsi[0], 3)));
      currentFuncPos--;
    case 3:
      phi(currentFuncPos, 0) =
          orient * (30 * (1 - 6 * qsi[0] + 6 * pow(qsi[0], 2)));
      currentFuncPos--;
    case 2:
      phi(currentFuncPos, 0) = orient * (-6 + 12 * qsi[0]);
      currentFuncPos--;
    case 1:
