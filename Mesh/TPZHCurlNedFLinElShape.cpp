...
void TPZHCurlNedFLinEl::Shape(TPZVec<REAL> &qsi, TPZFMatrix<REAL> &phi,
    ...
    case 12:
        phi(currentFuncPos, 0) =
            ...
            (16224936 * (-1 + 132 * qsi[0] - 4290 * pow(qsi[0], 2) +
    ...
    case 10:
        phi(currentFuncPos, 0) =
            ...
            (923780 * (-1 + 90 * qsi[0] - 1980 * pow(qsi[0], 2) +
                       18480 * pow(qsi[0], 3) - 90090 * pow(qsi[0], 4) +
                       252252 * pow(qsi[0], 5) - 420420 * pow(qsi[0], 6) +
                       411840 * pow(qsi[0], 7) - 218790 * pow(qsi[0], 8) +
                       48620 * pow(qsi[0], 9)));
        currentFuncPos--;
    case 9:
        phi(currentFuncPos, 0) =
    ...
    case 4:
        ...
        currentFuncPos--;
    case 3:
        phi(currentFuncPos, 0) = (30 * (1 - 6 * qsi[0] + 6 * pow(qsi[0], 2)));
        currentFuncPos--;
    case 2:
