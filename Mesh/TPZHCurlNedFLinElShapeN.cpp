#ifndef USING_HCURL_HIERARCHICAL
/**
 * @file
...
void TPZHCurlNedFLinEl::Shape(TPZVec<REAL> &qsi, TPZFMatrix<REAL> &phi,
    ...
    case 14:
        phi(currentFuncPos, 0) =
            orient * (-1 + 182 * qsi[0] - 8190 * pow(qsi[0], 2) +
    ...
    case 13:
        phi(currentFuncPos, 0) =
            orient * (1 - 156 * qsi[0] + 6006 * pow(qsi[0], 2) -
    ...
    case 12:
        phi(currentFuncPos, 0) =
            orient * (-1 + 132 * qsi[0] - 4290 * pow(qsi[0], 2) +
                      60060 * pow(qsi[0], 3) - 450450 * pow(qsi[0], 4) +
                      2018016 * pow(qsi[0], 5) - 5717712 * pow(qsi[0], 6) +
                      10501920 * pow(qsi[0], 7) - 12471030 * pow(qsi[0], 8) +
                      9237800 * pow(qsi[0], 9) - 3879876 * pow(qsi[0], 10) +
                      705432 * pow(qsi[0], 11));
        currentFuncPos--;
    case 11:
        phi(currentFuncPos, 0) =
            orient * (1 - 110 * qsi[0] + 2970 * pow(qsi[0], 2) -
    ...
    case 9:
        phi(currentFuncPos, 0) =
            orient * (1 - 72 * qsi[0] + 1260 * pow(qsi[0], 2) -
    ...
    case 8:
        phi(currentFuncPos, 0) =
            orient *
            (-1 + 56 * qsi[0] - 756 * pow(qsi[0], 2) + 4200 * pow(qsi[0], 3) -
             11550 * pow(qsi[0], 4) + 16632 * pow(qsi[0], 5) -
             12012 * pow(qsi[0], 6) + 3432 * pow(qsi[0], 7));
        currentFuncPos--;
    case 7:
        phi(currentFuncPos, 0) =
            orient * (1 - 42 * qsi[0] + 420 * pow(qsi[0], 2) -
    ...
    case 6:
        phi(currentFuncPos, 0) =
            orient *
            (-1 + 30 * qsi[0] - 210 * pow(qsi[0], 2) + 560 * pow(qsi[0], 3) -
             630 * pow(qsi[0], 4) + 252 * pow(qsi[0], 5));
        currentFuncPos--;
    case 5:
        phi(currentFuncPos, 0) =
            orient * (1 - 20 * qsi[0] + 90 * pow(qsi[0], 2) -
    ...
    case 4:
        ...
        currentFuncPos--;
    case 3:
        phi(currentFuncPos, 0) = orient * (1 - 6 * qsi[0] + 6 * pow(qsi[0], 2));
        currentFuncPos--;
    case 2:
        phi(currentFuncPos, 0) = orient * (-1 + 2 * qsi[0]);
        currentFuncPos--;
    case 1:
        phi(currentFuncPos, 0) = orient * (1);
        break;
    default:
